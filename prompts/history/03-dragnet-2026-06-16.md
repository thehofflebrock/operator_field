# DRAGNET — RAW POST PULL

> Became the current capture prompt (copy at ../capture-dragnet.md). Written after the first June 14 pull stopped at page one and called it complete.
